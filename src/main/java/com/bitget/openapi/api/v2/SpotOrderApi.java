...
public interface SpotOrderApi {
    ...
    Call<ResponseResult<PlaceOrderResponse>> placeOrder(@Body Map<String, String> body);
    ...
    Call<ResponseResult<List<OrderInfo>>> orderInfo(@QueryMap Map<String, String> params);
    ...
    Call<ResponseResult> historyOrders(@QueryMap Map<String, String> params);
